...
$factory->define(Configuration::class, function (Faker $faker) {
    ...
    $processor_manufacturer = ['AMD', 'Intel'];
    $processor_model = ['i5-9400F', 'i7-9700K', 'i9-9900K', 'Ryzen 5 1600X', 'Ryzen 7 1700X',
    ...
    return [
        ...
        'processor_manufacturer' => $processor_manufacturer[array_rand($processor_manufacturer)],
