...
defaults.headers = {
  common: {
    'Accept': 'application/json, text/plain, *}.call(this, __webpack_require__( "./node_modules/process/browser.js")))
 }),
...
(function (global, factory) {
    ...
    _proto.toggle = function toggle() {
      ...
      if (!this._inNavbar) {
        if (typeof Popper === 'undefined') {
          throw new TypeError('Bootstrap\'s dropdowns require Popper.js (https:
        }
  ...
  function () {
    function Tooltip(element, config) {
      if (typeof Popper === 'undefined') {
        throw new TypeError('Bootstrap\'s tooltips require Popper.js (https:
      } 
